...
if /I "%sshact%"=="non" (goto question_interface)
if /I "%sshact%"=="no" (goto question_interface)
if /I "%sshact%"=="n" (goto question_interface)
...
if /I "%demande_vlan%"=="p" (goto dquestion_menu)
